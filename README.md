...
Built a local osTicket help desk lab on Windows using XAMPP, Apache, PHP, and MySQL to gain hands-on experience with a real ticketing system for help desk roles.
